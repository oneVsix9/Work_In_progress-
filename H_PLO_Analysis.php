...
<head>
    ...
    <title>Higher Authority PLO Analysis</title>
...
<body>
    <nav class="navigation1">
        <div class="content2 flex-con">
            <div><h4>Reza Ahmed <br> Higher Authority</h4></div>
    ...
    <div class="content1">
        ...
        <div class="tab">
            <button class="custom-btn btn-9 tablinks" onclick="openCity(event, 'London')">Deparment/Program/School Wise Avarage </button>&nbsp;&nbsp;
            <button class="custom-btn btn-10 tablinks" onclick="openCity(event, 'Paris')">Overall CO. CLO Wise Analysis </button>
        </div>
        ...
        <h1>Higher Authority Plo Analysis</h1>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
